...
#include "ivanp/program_options/opt_match.hh"
#include "ivanp/program_options/opt_parser.hh"
#include "ivanp/program_options/opt_init.hh"
#include "ivanp/program_options/opt_def.hh"
#else
#include "ivanp/program_options/fwd/opt_match.hh"
#include "ivanp/program_options/fwd/opt_parser.hh"
#include "ivanp/program_options/fwd/opt_def.hh"
#endif
...
public:
  ...
  std::enable_if_t<!is_std_tuple<std::decay_t<Matcher>>::value,program_options&>
  operator()(T& x,
    Matcher&& matcher,
    std::string descr={}, Props&&... p
  ) {
